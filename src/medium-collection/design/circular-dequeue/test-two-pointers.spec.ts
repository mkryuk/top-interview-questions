...
describe("Design Circular Deque ", () => {
  ...
  it("MyCircularDeque should pass test 2", () => {
  ...
  it("MyCircularDeque should pass test 3", () => {
    var myCircularDeque = new MyCircularDeque(5);
    expect(myCircularDeque.insertFront(2)).toBeTrue();
    expect(myCircularDeque.insertFront(1)).toBeTrue();
    expect(myCircularDeque.insertLast(3)).toBeTrue();
    expect(myCircularDeque.insertLast(4)).toBeTrue();
    expect(myCircularDeque.insertFront(0)).toBeTrue();
    expect(myCircularDeque.getFront()).toEqual(0);
    expect(myCircularDeque.getRear()).toEqual(4);
  });
});
