...
it('multiply should return "64452" for num1 = "123", num2 = "524"', () => {
  const num1 = "123";
  const num2 = "524";
  const result = multiply(num1, num2);
  expect(result).toEqual("64452");
});

it('multiply should return "20880" for num1 = "696", num2 = "30"', () => {
  const num1 = "696";
  const num2 = "30";
  const result = multiply(num1, num2);
  expect(result).toEqual("20880");
});
